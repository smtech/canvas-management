...
function stmarks_gradingAnalytics() {
	...
	if (courseAnalyticsButton != null) {
		...
		gradingAnalyticsButton.href = 'https://area51.stmarksschool.org/project/canvas/dev/api/grading-analytics/course-summary.php?course_id=' + courseId + '&hash=' + md5('test');
